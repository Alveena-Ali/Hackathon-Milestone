...
<p><center><b>Name:</b> <span contenteditable="true">${name}</span></center></p>
<p><center><b>Email:</b> <span contenteditable="true">${email}</span></center></p>
<p><center><b>Contact:</b> <span contenteditable="true">${contact}</span></center></p>

<h2><center>Education</center></h2>
<p contenteditable="true"><center>${education}</center></p>

<h2><center>Experience</center></h2>
<p contenteditable="true"><center>${experience}<center></p>

<h2><center>Skills</center></h2>
<ul contenteditable="true"><center>${skillsHTML}</center></ul>
`;
