...
form.addEventListener('submit', function (event) {
    ...
    var generateResumeHTML = function (profilePicURL) {
        ...
        var resumeHTML = "\n<h1><center>Editable Resume<center></h1>\n<h2><center>Personal Information</center></h2>\n\n<!-- Display Profile Picture only if provided -->\n".concat(profilePicURL
            ? "<img src=\"".concat(profilePicURL, "\" alt=\"Profile Picture\" style=\"max-width: 150px; border-radius: 50%;\">")
            : '', "\n\n<p><center><b>Name:</b> <span contenteditable=\"true\">").concat(name, "</span></center></p>\n<p><center><b>Email:</b> <span contenteditable=\"true\">").concat(email, "</span></center></p>\n<p><center><b>Contact:</b> <span contenteditable=\"true\">").concat(contact, "</span></center></p>\n\n<h2><center>Education</center></h2>\n<p contenteditable=\"true\"><center>").concat(education, "</center></p>\n\n<h2><center>Experience</center></h2>\n<p contenteditable=\"true\"><center>").concat(experience, "<center></p>\n\n<h2><center>Skills</center></h2>\n<ul contenteditable=\"true\"><center>").concat(skillsHTML, "</center></ul>\n");
